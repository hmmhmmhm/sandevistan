...
const english: AiStrings = {
  ...
  keylessDataInfo: "Weather and map use cached public data. No API key is required.",
...
const localized: Partial<Record<SupportedLocale, Partial<AiStrings>>> = {
  ...
  ko: { ai: "AI에게 묻기", openAiKey: "OpenAI API 키", byokKeys: "BYOK 키", dashboardMap: "대시보드 지도", keylessDataInfo: "날씨와 지도는 캐시된 공개 데이터를 사용합니다. 별도 API 키가 필요 없습니다.", estimatedCost: "예상 Realtime 비용", thisWeek: "이번 주", thisMonth: "이번 달", recentConversations: "최근 대화", noConversations: "아직 대화가 없습니다", clearAiData: "AI 기록 및 사용량 지우기", aiKeyRequired: "OpenAI 키 필요" },
